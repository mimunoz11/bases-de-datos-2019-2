...
<script language="JavaScript">
  ...
  function mostrar(numero_) {
    ...
    if (document.getElementById("check_desplegar").checked) {
      ...
      if (1 == 1) {
        $.post("../navegacion/ong_recursos.php?id=(" + numero_ + ")", {}, function(mensaje) {
          espacio_recursos.html(mensaje);
        });
        $.post("../navegacion/ong_movilizaciones.php?id=(" + numero_ + ")", {}, function(mensaje) {
        ...
        if ($dataCollected === 0) {
          ...
          //La variable $resultado contiene el array que se genera en la consulta, así que obtenemos los datos y los mostramos en un bucle
              foreach ($dataCollected as $p) {
                  ...
                  $mensaje .= "<tr > $columna <td value='$formato_nombre' onClick=$funcion_mostrar style='color:$color_fondo'>$p[0]</td> <td style='display:none'><a id='enlace_$formato_nombre' href=../navegacion/ong.php?id=($formato_nombre_enlace)></a></td></tr>";
