...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Grupo 06
        <h6> Cote Garrido, Raul DC, Manu Muñoz & Joaco Terreros</h6>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <form method="post" action="consultas_login/registro_socios.php">
              <h6 class="text-center text-secondary mb-0">
  ...
  <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <div <p class="masthead-subheading font-weight-light mb-0"> Ingrese su nombre</p></div>
          <input type="text" name="nombre">
          <div class="divider-custom-line"></div>
          <div <p class="masthead-subheading font-weight-light mb-0"> Ingrese su apellido</p></div>
            <input type="text" name="apellido">
            <div class="divider-custom-line"></div>
          <form method="post" action="consultas_login/ingreso_socios.php">
            <h6 class="text-center text-secondary mb-0">
