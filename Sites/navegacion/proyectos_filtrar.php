...
if (isset($consultaBusqueda)) {
	$query = "SELECT Proyectos.pid AS id, tipo, nombre, latitud, longitud, Proyectos.comuna, region, fecha_apertura, operativo FROM Proyectos INNER JOIN Comunas ON Proyectos.comuna = Comunas.comuna WHERE tipo IN ($consultaBusqueda)";
